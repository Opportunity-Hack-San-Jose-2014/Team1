$rmod.def("/marko-widgets@1.1.12/lib/Widget", function(require, exports, module, __filename, __dirname) { /*
...
var raptorWidgets = require('/$/marko-widgets'/*'marko-widgets'*/);
...
var SubscriptionTracker = require('/$/marko-widgets/$/raptor-util/SubscriptionTracker'/*'raptor-util/SubscriptionTracker'*/);
