$rmod.def("/marko-widgets@1.1.12/lib/init-widgets-browser", function(require, exports, module, __filename, __dirname) { require('/$/marko-widgets/$/raptor-polyfill/array/forEach'/*'raptor-polyfill/array/forEach'*/);
